...
// ];
    ...
    defaultCategory: QuestionTableData = {
      categoryId: 0,
      category: "Add Category",
      questions: []
    }

  defaultDataSource: QuestionTableData[] = []
  buildDefault(): QuestionTableData[]{
      for(let i = 0; i < 6; i++){
        this.defaultDataSource.push(new QuestionList().defaultCategory)
        for(let j = 0; j < 5; j++){
          this.defaultDataSource[i].questions.push(new QuestionList().defaultQuestion)
        }
      }
      console.log(this.defaultDataSource)
      return this.defaultDataSource
  }

//     defaultDataSource: QuestionTableData2[] = [
//       {
//         categoryId: 0,
//         category: 'Add Category',
//         questions: 
